...
export default function Page() {
  ...
  if (loading) {
    return (
      <div className="h-screen flex items-center justify-center bg-gradient-to-br from-[#ffefd1] to-white">
        <div className="flex flex-col items-center space-y-4">
          <div className="w-20 h-20 bg-[#FFC155]/30 rounded-full animate-pulse"></div>
          <div className="w-20 h-6 bg-[#FFC155]/30 rounded-full animate-pulse"></div>
          <div className="w-20 h-6 bg-[#FFC155]/30 rounded-full animate-pulse"></div>
        </div>
      </div>
    );
    ...
    <div className="relative min-h-screen bg-gradient-to-br from-[#ffefd1] to-white">
      <div
        className={cn([
          ...
          "overflow-hidden",
          "lg:rounded-2xl",
          "lg:shadow-[0_15px_50px_rgba(255,193,85,0.25)]",
          "lg:max-h-[720px]",
      ...
      >
        ...
        <div className="relative flex items-center justify-center bg-gradient-to-b from-[#FFC155]/5 to-[#FFC155]/10 p-8 pt-20 lg:h-full">
          <div className="absolute left-0 top-8 w-full text-center">
            <Text
              ...
              color="black/900"
              weight={600}
              className="relative inline-block text-[#FFC155]"
            >
              Welcome to Elastica.
              <div className="absolute -bottom-2 left-0 h-1 w-full transform bg-[#FFC155] scale-x-0 transition-transform duration-300 group-hover:scale-x-100"></div>
            </Text>
          </div>
          ...
          {/* Decorative elements */}
          <div className="absolute top-16 left-16 w-8 h-8 rounded-full bg-[#FFC155]/20 animate-pulse"></div>
          <div className="absolute bottom-16 right-16 w-12 h-12 rounded-full bg-[#FFC155]/30 animate-pulse"></div>
          <div className="absolute top-1/3 right-16 w-6 h-6 rounded-full bg-[#FFC155]/40 animate-pulse"></div>
        </div>
          ...
          >
            <div className="space-y-4">
              <h1 className="font-poppins text-[42px] font-medium text-[#121212] tracking-tight">
                Sign In <span className="text-[#FFC155]">.</span>
              </h1>
            ...
            <form onSubmit={handleEmailLogin} className="space-y-6">
              ...
              <div className="flex justify-end">
                <Link
                  ...
                  className="text-sm text-gray-500 hover:text-[#FFC155] transition-colors"
                >
                  Forgot Password?
                </Link>
              </div>
              ...
              <div className="flex items-center justify-center">
                <button
                  ...
                  className={cn(
                    ...
                    "transform transition-all duration-200",
                    "hover:border-[#FFC155] hover:shadow-md hover:shadow-[#FFC155]/10",
                    "active:scale-[0.98]",
