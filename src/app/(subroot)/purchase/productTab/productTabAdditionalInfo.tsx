      ...
      <div className="space-y-6">
        ...
        >
          ...
          >
            {specifications.slice(0, 5).map((spec, index) => (
              <motion.li
                ...
                className="flex text-gray-800 justify-between py-3 px-4 font-inter text-sm font-normal border-b border-gray-50 odd:bg-white even:bg-gray-50/30 hover:bg-emerald-50/30 transition-colors duration-200"
              >
          ...
          <div className="flex justify-center pt-4">
            <ProductTabDialog
              trigger={
                <button className="group relative overflow-hidden rounded-full border border-emerald-500 px-10 py-2.5 font-inter text-base font-medium text-gray-800 shadow-sm transition-all duration-300 hover:shadow-md hover:text-emerald-700">
                  <span className="relative z-10">View All Specifications</span>
                  <span className="absolute inset-0 -z-0 bg-gradient-to-r from-emerald-100/40 to-emerald-200/40 opacity-0 transition-opacity duration-300 group-hover:opacity-100"></span>
                  <span className="absolute bottom-0 left-0 h-0.5 w-full bg-gradient-to-r from-transparent via-emerald-400 to-transparent opacity-70"></span>
                </button>
              }
            >
              <div className="space-y-8 p-2">
                ...
                <div className="text-center mb-6">
                  ...
                  <div className="mx-auto h-0.5 w-24 bg-gradient-to-r from-transparent via-emerald-400 to-transparent mt-2"></div>
                </div>
